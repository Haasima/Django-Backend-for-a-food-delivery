...
SECRET_KEY = 'django-insecure-o7nn4xx++r=pvao2pjv7hxylddd2@_%8&no8p40h=-szjzdkx-'
...
AUTHENTICATION_BACKENDS = [
    ...
    'token_auth.authenticate.PhoneAuthBackends'
]

AUTH_USER_MODEL = 'token_auth.CustomUser'
