# Generated by Django 4.2.7 on 2024-06-03 23:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='role',
            field=models.CharField(choices=[('COURIER', 'Courier'), ('CLIENT', 'Client')], default='CLIENT', max_length=20),
        ),
        migrations.CreateModel(
            name='UserAddress',
            fields=[
                ...
                ('entrance_number', models.PositiveIntegerField(blank=True)),
                ('code_number', models.CharField(blank=True, max_length=8)),
                ('apartment_number', models.PositiveIntegerField(blank=True)),
                ('city', smart_selects.db_fields.ChainedForeignKey(chained_field='country', chained_model_field='country', on_delete=django.db.models.deletion.CASCADE, related_name='cities', to='token_auth.city')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='countries', to='token_auth.country')),
